CREATE DATABASE  IF NOT EXISTS `music_box_db` /*!40100 DEFAULT CHARACTER SET utf8mb4*/ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `music_box_db`;
...
-- Dump completed on 2021-12-09 16:28:03
